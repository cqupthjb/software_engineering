	...
	$.ajax({
		...
		success: function(data){
			...
			if (data.hasOwnProperty('status')){
			    if (data.status==1){
			        var text = '<a href="javascript:void(0)" id="favorite_add">' +
                        '<em class="goods_nav3" style="background: url(\'/Template/mobile/new/Static/images/like2.png\') no-repeat center;background-size: auto 90%;"></em>' +
                        '<span>已收藏</span></a>';
			        $('.is_like').html(text)
                }
            }
