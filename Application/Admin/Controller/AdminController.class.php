...
class AdminController extends BaseController {
    ...
    public function admin_info(){
    	...
    	#region 角色判断 Mr-X  X不用
        //>>5->省级  6->地级  7->县级  8->分销员（分销商）
//        $admin_role_id = D('admin')->where(array('admin_id'=>session('admin_id')))->getField('role_id');
//        $map = array();
//        switch ($admin_role_id){
//            case 1:
//                $map['role_id'] = array('not in',array(6,7,8));
//                break;
//            case 5:
//                $map['role_id'] = array('eq',6);
//                break;
//            case 6:
//                $map['role_id'] = array('eq',7);
//                break;
//            case 7:
//                $map['role_id'] = array('eq',8);
//                break;
//            default:
//                $map = '1=1';
//                break;
//        }
    	...
    	$role = D('admin_role')->where('i=1')->select();
