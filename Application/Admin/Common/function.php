...
function getAllMenu(){
	return	array(
        'system' => array('name'=>'系统设置','icon'=>'fa-cog','sub_menu'=>array(
                ...
                array('name'=>'手机导航','act'=>'navigationList','control'=>'MobileNav'),
        ...
        'order' => array('name' => '订单管理', 'icon'=>'fa-money', 'sub_menu' => array(
            ...
            array('name' => '收款码订单列表', 'act'=>'scan_order', 'control'=>'Order'),
        )),
        'distribut' => array('name' => '分销管理', 'icon'=>'fa-cubes', 'sub_menu' => array(
            ...
            array('name' => '其它分销关系', 'act'=>'tree2', 'control'=>'Distribut'),
            array('name' => '分销设置', 'act'=>'set', 'control'=>'Distribut'),
            //array('name' => '提现申请', 'act'=>'withdrawals', 'control'=>'Distribut'), //应该是下面的商家提现 和 会员提现了
            array('name' => '分成日志', 'act'=>'rebate_log', 'control'=>'Distribut'),
            array('name' => '分销角色', 'act' => 'role_list','control'=>'Distribution'),
            array('name' => '折扣管理', 'act' => 'index','control'=>'Discount'),
        )),
        'Card' => array('name' => '积分票管理', 'icon'=>'fa-cc-mastercard', 'sub_menu' => array(
            array('name' => '积分票列表', 'act'=>'index', 'control'=>'Card'),
            array('name' => '订单列表', 'act'=>'order_list', 'control'=>'Card'),
            array('name' => '发货列表', 'act'=>'delivery_list', 'control'=>'Card'),
            array('name' => '积分票分成', 'act'=>'rebate_log', 'control'=>'Card'),
            array('name' => '分成统计', 'act'=>'card_rebate_log', 'control'=>'Report'),
            array('name' => '销售情况', 'act'=>'card_index', 'control'=>'Report'),
            array('name' => '销售排行', 'act'=>'card_saleTop', 'control'=>'Report'),
        )),
        /*'promotion' => array('name' => '活动管理', 'icon'=>'fa-bell', 'sub_menu' => array(
                //array('name' => '抢购管理', 'act'=>'flash_sale', 'control'=>'Promotion'),
                //array('name' => '团购管理', 'act'=>'c', 'control'=>'Promotion'),
        ...
        'content' => array('name' => '内容管理', 'icon'=>'fa-comments', 'sub_menu' => array(
                ...
                array('name' => '反馈消息', 'act'=>'index', 'control'=>'Feedback'),
                //array('name' => '反馈消息', 'act'=>'feedbackList', 'control'=>'Article'),
        ...
        'ActivityCard' => array('name' => '活动票管理', 'icon'=>'fa-cc-mastercard', 'sub_menu' => array(
            array('name' => '领取活动票', 'act'=>'index', 'control'=>'ActivityCard'),
            array('name' => '活动票列表', 'act'=>'card_index', 'control'=>'ActivityCard'),
            array('name' => '活动票等级', 'act'=>'level_index', 'control'=>'ActivityCard'),
            array('name' => '会员领取列表', 'act'=>'log_index', 'control'=>'ActivityCard'),
        )),
        'UserCard' => array('name' => '会员卡管理', 'icon'=>'fa-cc-mastercard', 'sub_menu' => array(
            array('name' => '激活日志', 'act'=>'log_index', 'control'=>'UserCard'),
            array('name' => '会员卡列表', 'act'=>'card_index', 'control'=>'UserCard'),
            array('name' => '会员卡面值', 'act'=>'level_index', 'control'=>'UserCard'),
        )),
        ...
        'finance' => array('name' => '财务统计', 'icon'=>'fa-book', 'sub_menu' => array(
                ...
                array('name' => '个人提现申请', 'act'=>'withdrawals', 'control'=>'Finance'),
                array('name' => '个人汇款记录', 'act'=>'remittance', 'control'=>'Finance'),
        ...
        'count' => array('name' => '统计报表', 'icon'=>'fa-signal', 'sub_menu' => array(
                ...
                array('name' => '卡券分成', 'act'=>'card_rebate_log', 'control'=>'Report'),
        )),
        ...
        'tools' => array('name' => '备份还原', 'icon'=>'fa-plug', 'sub_menu' => array(
