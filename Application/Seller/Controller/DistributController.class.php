...
class DistributController extends BaseController {
    ...
    { 
        ...
        if (in_array($this->_seller['role_id'],array(1,2,3,4))){
            $where = 'user_id ='.$this->_seller['user_id'] ." and create_time >= '".strtotime($create_time2[0])."' and create_time <= '".strtotime($create_time2[1])."' ";
        }
