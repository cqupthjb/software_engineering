...
return array(
    /* 加载公共函数 */
    'LOAD_EXT_FILE' =>'common,function_yq',
    'AUTH_CODE' => "TPSHOP", //安装完毕之后不要改变，否则所有密码都会出错
    //'URL_CASE_INSENSITIVE' => false, //URL大小写不敏感
    'LOAD_EXT_CONFIG'=>'db,route,config_yq', // 加载数据库配置文件
    'LOAD_EXT_CONFIG'=>'db,config_yq', // 加载数据库配置文件
    /*
     * RBAC认证配置信息
     */
...
//     'REQUIRE_AUTH_ACTION'       => '',        // 默认需要认证操作
    ...
    'SPHINX_PORT'         =>      '9312',
	/*****************************以下是新增的配置（wj,2016-11-16）************************************/	
	//'LOAD_EXT_CONFIG' => 'config_yq',//加载新增的配置文件
	//'LOAD_EXT_FILE'=> 'function_yq',//加载新增的函数库
